...
export const updateConductorSchema = z
  .object({
...
export const assignConductorSchema = z
  .object({
...
export const setConductorStatusSchema = z
  .object({
    status: z.enum(STATUSES),
  })
  .strict();

export const recordConductorAttendanceSchema = z
  .object({
    date: z.coerce.date(),
